...
import { sicruxAnimations } from '@system/animations';
import { MatColors } from '@system/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const SICRUX_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => SystemMaterialColorPickerComponent),
  multi: true,
};
...
@Component({
  ...
  animations: sicruxAnimations,
  encapsulation: ViewEncapsulation.None,
  providers: [SICRUX_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR],
})
export class SystemMaterialColorPickerComponent
